...
const ExpenseItem = props => {
  const [title, setTitle] = useState(props.title) // this props.title is only considered when the component function is being executed for the first time.
  console.log("ExpenseItem created by React.")
